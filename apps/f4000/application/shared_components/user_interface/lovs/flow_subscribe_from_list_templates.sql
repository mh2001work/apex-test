...
begin
--   Manifest
--     FLOW_SUBSCRIBE_FROM_LIST_TEMPLATES
--   Manifest End
...
,p_static_id=>'flow-subscribe-from-list-templates'
,p_lov_query=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select ''- '' || lower(wwv_flow_lang.system_message(''NO_TEMPLATE'')) || '' -'' d, 0 r ',
'  from sys.dual ',
' union all',
'select flow_id ||'' : ''|| list_template_name || nvl2( theme_id, '' ('' || theme_id || '')'', '''' ) d, id r',
...
,p_version_scn=>'SH256:RrvScfKcH9Lw97L3S5l0mo_YXKNR8dEoWa1dLKjURFQ'
);
