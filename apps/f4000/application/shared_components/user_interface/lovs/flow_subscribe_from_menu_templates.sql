...
begin
--   Manifest
--     FLOW_SUBSCRIBE_FROM_MENU_TEMPLATES
--   Manifest End
...
,p_static_id=>'flow-subscribe-from-menu-templates'
,p_lov_query=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select ''- '' || lower(wwv_flow_lang.system_message(''NO_TEMPLATE'')) || '' -'' d, 0 r ',
'  from sys.dual ',
' union all',
'select flow_id ||'' : ''|| name || nvl2( theme_id, '' ('' || theme_id || '')'', '''' ) d, id r',
...
,p_version_scn=>'SH256:PZVBiUeyigCIjRmmXey1nWQxX-dGpNotOq9vYpWjfIE'
);
