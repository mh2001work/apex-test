prompt --application/shared_components/navigation/lists/working_copies_for_main_app_menu
begin
--   Manifest
--     LIST: Working Copies (For Main App Menu)
--   Manifest End
...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(1421615343198967)
,p_name=>'Working Copies (For Main App Menu)'
,p_static_id=>'working-copies-for-main-app-menu'
...
'order by a.id'))
,p_version_scn=>'SH256:gXr5GAPnb1NJCjldomQXeePh0XI9YFzztVJXUCWwBM4'
);
